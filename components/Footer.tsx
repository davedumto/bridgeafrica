        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 max-w-2xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-3">
              ...
              <li>
                <a href="https://youtube.com/@bridgeafrica-q4h?si=Fc7iFXLFhW2pIlpr" target="_blank" rel="noopener noreferrer" className="text-sm md:text-base transition-colors hover:underline text-[#0A2342] dark:text-gray-300">
                  Videos
                </a>
              </li>
              <li>
        ...
        <div className="max-w-[1400px] xl:max-w-[1600px] mx-auto px-6 md:px-12 lg:px-[80px] xl:px-[120px] py-4 md:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <a href="https://youtube.com/@bridgeafrica-q4h?si=Fc7iFXLFhW2pIlpr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110" style={{
              ...
              <a href="https://www.instagram.com/bridgeafrica98?igsh=MW03cGNqc3p2aWhnOA==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110" style={{
              backgroundColor: '#F6BE00'
            }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#0A2342">
              ...
              <a href="https://www.tiktok.com/@bridgeafrica?_r=1&_t=ZS-91fYvUJ4CgR" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110" style={{
              backgroundColor: '#F6BE00'
            }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#0A2342">
